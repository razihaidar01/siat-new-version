      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-14 sm:py-20 text-center">
            ...
            >
              Get up to <strong className="text-white">₹4 lakh</strong> financial support for higher education.
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600 text-sm sm:text-base leading-relaxed">
                  {[
                    ...
                    "Provides up to ₹4 lakh financial support for higher education after 12th. Covers tuition fees, hostel, food expenses, and books & stationery.",
                    "Easy repayment terms. Repayment starts 1 year after course or 6 months after getting a job.",
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                { icon: "💰", step: "6", title: "Disbursement", desc: "Amount goes directly to the college. Your education begins!" },
              ].map((s, i) => (
